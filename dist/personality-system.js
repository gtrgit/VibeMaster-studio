...
exports.NPC_PERSONALITIES = void 0;
exports.getPersonalityDescription = getPersonalityDescription;
...
function getPersonalityDescription(traits) {
    ...
    if (traits.openness > 70)
        descriptions.push("creative and curious");
    else if (traits.openness < 30)
        descriptions.push("traditional and practical");
    // Conscientiousness
    if (traits.conscientiousness > 70)
        descriptions.push("disciplined and reliable");
    else if (traits.conscientiousness < 30)
        descriptions.push("spontaneous and flexible");
    // Extraversion
    if (traits.extraversion > 70)
        descriptions.push("outgoing and talkative");
    else if (traits.extraversion < 30)
        descriptions.push("quiet and reserved");
    // Agreeableness
    if (traits.agreeableness > 70)
        descriptions.push("helpful and trusting");
    else if (traits.agreeableness < 30)
        descriptions.push("skeptical and independent");
    // Neuroticism
    if (traits.neuroticism > 70)
        descriptions.push("anxious and moody");
    else if (traits.neuroticism < 30)
        descriptions.push("calm and stable");
    return descriptions;
}
...
//# sourceMappingURL=personality-system.js.map