...
async function seed() {
    ...
    const marcus = await db.nPC.create({
        data: {
            ...
            agreeableness: 60,
            neuroticism: 50,
            values: (0, database_1.safeJsonStringify)(['family', 'honesty', 'hard work']),
            fears: (0, database_1.safeJsonStringify)(['losing loved ones', 'failure']),
            // Speech pattern - terse, direct
            formality: 40,
            verbosity: 30,
            emotionalExpression: 40,
            dialect: 'working class',
            speechQuirks: (0, database_1.safeJsonStringify)(['uses short sentences', 'gruff tone']),
            // Needs - stable
            needFood: 70,
            needSafety: 90,
            needWealth: 60,
    ...
    const sarah = await db.nPC.create({
        data: {
            ...
            agreeableness: 85,
            neuroticism: 40,
            values: (0, database_1.safeJsonStringify)(['helping others', 'knowledge', 'nature']),
            fears: (0, database_1.safeJsonStringify)(['violence', 'darkness']),
            // Speech pattern - friendly, articulate
            formality: 60,
            verbosity: 70,
            emotionalExpression: 80,
            speechQuirks: (0, database_1.safeJsonStringify)(['uses plant metaphors']),
            // Needs - healthy
            needFood: 85,
            needSafety: 80,
            needWealth: 40,
    ...
    const emma = await db.nPC.create({
        data: {
            ...
            agreeableness: 80,
            neuroticism: 45,
            values: (0, database_1.safeJsonStringify)(['community', 'tradition', 'kindness']),
            fears: (0, database_1.safeJsonStringify)(['hunger', 'loneliness']),
            // Speech pattern - warm, conversational
            formality: 50,
            verbosity: 60,
            emotionalExpression: 75,
            speechQuirks: (0, database_1.safeJsonStringify)(['maternal tone', 'uses food metaphors']),
            // Needs - stable
            needFood: 90,
            needSafety: 85,
            needWealth: 55,
    ...
    await db.player.create({
        data: {
            name: 'Player',
            reputation: 50,
            relationships: (0, database_1.safeJsonStringify)({}),
            activeQuests: (0, database_1.safeJsonStringify)([]),
            completedQuests: (0, database_1.safeJsonStringify)([]),
            failedQuests: (0, database_1.safeJsonStringify)([]),
            recentChoices: (0, database_1.safeJsonStringify)([])
        }
    });
